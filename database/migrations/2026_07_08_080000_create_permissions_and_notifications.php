...
return new class extends Migration{public function up():void{
 ...
 Schema::create('user_devices',function(Blueprint$t){$t->id();$t->foreignId('user_id')->constrained()->cascadeOnDelete();$t->string('name');$t->string('platform')->nullable();$t->string('push_token')->unique();$t->dateTime('last_seen_at')->nullable();$t->boolean('active')->default(true);$t->timestamps();});
 ...
 }public function down():void{Schema::dropIfExists('notifications');Schema::dropIfExists('user_devices');Schema::dropIfExists('permission_role');Schema::dropIfExists('permissions');}};

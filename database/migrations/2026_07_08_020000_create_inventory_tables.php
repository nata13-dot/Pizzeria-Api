...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('units', function (Blueprint $table): void {
            ...
            $table->decimal('base_factor', 16, 6)->default(1);
        ...
        Schema::create('ingredient_types', function (Blueprint $table): void {
            ...
            $table->unsignedInteger('suggested_shelf_life_days')->nullable();
        ...
        Schema::create('ingredients', function (Blueprint $table): void {
            ...
            $table->decimal('critical_stock', 16, 4)->default(0);
        ...
        Schema::create('ingredient_presentations', function (Blueprint $table): void {
            ...
            $table->foreignId('equivalent_unit_id')->constrained('units');
            $table->decimal('base_quantity', 16, 4);
        ...
        Schema::create('purchases', function (Blueprint $table): void {
            ...
            $table->enum('payment_source', ['cash', 'owner', 'bank', 'credit', 'other']);
        ...
        Schema::create('purchase_items', function (Blueprint $table): void {
            ...
            $table->decimal('presentations_quantity', 12, 4);
            $table->decimal('base_quantity', 16, 4);
            $table->decimal('total_cost', 14, 2);
            $table->decimal('base_unit_cost', 16, 6);
        ...
        Schema::create('inventory_batches', function (Blueprint $table): void {
            ...
            $table->decimal('initial_quantity', 16, 4);
            $table->decimal('available_quantity', 16, 4);
        ...
        Schema::create('inventory_adjustments', function (Blueprint $table): void {
            ...
            $table->foreignId('user_id')->constrained();
            $table->decimal('quantity', 16, 4);
            $table->enum('reason', ['waste', 'expiry', 'preparation_error', 'gift', 'internal_use', 'manual', 'loss', 'initial', 'correction']);
            $table->text('comment')->nullable();
            $table->timestamps();
        });
    ...
    {
        foreach (['alerts', 'inventory_adjustments', 'inventory_movements', 'inventory_batches', 'purchase_items', 'purchases', 'suppliers', 'ingredient_presentations', 'ingredients', 'ingredient_types', 'units'] as $table) {
